  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="bg-gradient-to-r from-[#0d153a] to-[#1e2a5e] text-white p-8 rounded-3xl relative overflow-hidden shadow-lg border border-white/5">
        <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-[#ff7a00]/10 blur-2xl" />
        <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-blue-500/10 blur-2xl" />
        
        <div className="relative z-10 space-y-4 max-w-2xl">
          <span className="bg-[#ff7a00]/25 text-[#ffab66] border border-[#ff7a00]/30 text-xs font-black px-3.5 py-1.5 rounded-full uppercase tracking-widest inline-block">
            Bảng điều khiển Admin
          </span>
          <h1 className="text-3xl md:text-4xl font-black tracking-tight leading-tight">
            Chào mừng đến với <span className="text-[#ff7a00]">QualiCode</span> Dashboard!
          </h1>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow group">
          <div className="space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-orange-50 text-[#ff7a00] flex items-center justify-center flex-shrink-0">
              <Users className="w-6 h-6" />
            </div>
            <div className="space-y-1.5">
              <h3 className="text-lg font-black text-[#0d153a] group-hover:text-[#ff7a00] transition-colors">
                Quản lý Người dùng
              </h3>
          ...
          <div className="pt-6">
            <Link
              href="/admin/users"
              className="inline-flex items-center gap-2 text-sm font-bold text-[#ff7a00] hover:text-orange-600 transition-colors"
            >
      ...
      <section className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm flex items-center justify-around text-center flex-wrap gap-4 py-8">
        ...
        <div>
          <div className="flex items-center justify-center text-[#ff7a00] mb-1">
